...
# Fit model through the origin
tm.reg2 <- lm(teamPts ~ tmPrd - 1)
summary(tm.reg2)
anova(tm.reg2)
confint(tm.reg2) # Because n is big, f-test is not valid. 
# So rely on t-test and/or CI (which is very tight for large n)
