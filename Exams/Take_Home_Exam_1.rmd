...
confint(lm_1)
```
5. Give the 95% confidence interval for E{Y|X=150} FIXME

```{r}
X_value <- data.frame(x=150)
predict(lm_1, X_value, interval="confidence", level=0.95)
```

6. Give the 95% prediction interval for a new observation when X=150 FIXME
